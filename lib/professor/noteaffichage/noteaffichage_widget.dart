...
import 'noteaffichage_model.dart';
export 'noteaffichage_model.dart';
...
/// Firestore.
class NoteaffichageWidget extends StatefulWidget {
  const NoteaffichageWidget({
    super.key,
    required this.reccord,
  });

  final AcademicRecordsRecord? reccord;

  static String routeName = 'noteaffichage';
  static String routePath = '/noteaffichage';

  @override
  State<NoteaffichageWidget> createState() => _NoteaffichageWidgetState();
}

class _NoteaffichageWidgetState extends State<NoteaffichageWidget> {
  late NoteaffichageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoteaffichageModel());
  }
            ...
            Padding(
              ...
              child: StreamBuilder<List<AcademicRecordsRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  int successCount = listViewAcademicRecordsRecordList
                      .where((record) => (record.note ?? 0.0) >= 10.0)
                      .length;
                  int failCount = listViewAcademicRecordsRecordList
                      .where((record) => (record.note ?? 0.0) < 10.0)
                      .length;
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            child: Text(
                                              listViewAcademicRecordsRecord.note
                                                  .toString(),
                                              style:
