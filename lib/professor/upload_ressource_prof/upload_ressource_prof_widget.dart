...
import 'upload_ressource_prof_model.dart';
export 'upload_ressource_prof_model.dart';
...
class UploadRessourceProfWidget extends StatefulWidget {
  const UploadRessourceProfWidget({super.key});

  static String routeName = 'UploadRessourceProf';
  static String routePath = '/uploadRessourceProf';

  @override
  State<UploadRessourceProfWidget> createState() =>
      _UploadRessourceProfWidgetState();
}

class _UploadRessourceProfWidgetState extends State<UploadRessourceProfWidget> {
  late UploadRessourceProfModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UploadRessourceProfModel());
                        ...
                        child: StreamBuilder<List<AcademicRecordsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final containerAcademicRecordsRecord =
                                containerAcademicRecordsRecordList.isNotEmpty
                                    ? containerAcademicRecordsRecordList.first
                                    : null;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowDropDown<String>(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Lien de la ressource',
                                        ...
                                        onPressed: () async {
                                          await AcademicRecordsRecord.collection
                                              ...
                                              .set(
                                                ...
                                                description:
                                                    _model.textController2.text,
                                                fileUrl: _model.textController3.text,
                                                type: _model.dropDownValue3,
                                                module: '',
                                                note: 0.0,
                                              ));
                                          ...
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              'record': serializeParam(
                                                containerAcademicRecordsRecord,
                                                ParamType.Document,
                                              ),
                                            }.withoutNulls,
