...
import 'notes_prof_model.dart';
export 'notes_prof_model.dart';
...
class NotesProfWidget extends StatefulWidget {
  const NotesProfWidget({super.key});

  static String routeName = 'NotesProf';
  static String routePath = '/notesProf';

  @override
  State<NotesProfWidget> createState() => _NotesProfWidgetState();
}

class _NotesProfWidgetState extends State<NotesProfWidget> {
  late NotesProfModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotesProfModel());

    _model.coefficientTextController ??= TextEditingController();
